...
class _FoodDetailScreenState extends State<FoodDetailScreen> {
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: FilledButton.icon(
                      ...
                      label: Text(_loadingStory ? 'Discovering...' : 'Discover the Story Behind This Dish'),
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Text('Traditional Cuisine', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 13)),
                  ),
                ],
              ),
            ),
  ...
  Widget _buildStory(ThemeData theme) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        if (_story!['originStory'] != null) ...[
          _section('Origin Story', _story!['originStory']),
          const SizedBox(height: 14),
        ],
        if (_story!['ingredients'] != null) ...[
          _listSection('Key Ingredients', List<String>.from(_story!['ingredients'])),
          const SizedBox(height: 14),
        ],
        if (_story!['preparationMethod'] != null) ...[
          _section('Preparation', _story!['preparationMethod']),
          const SizedBox(height: 14),
        ],
